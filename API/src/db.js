...
const {
    ...
    DB_USER_CLOUD,
    DB_NAME_CLOUD,
    DB_PORT_CLOUD,DB_HOST, DB_PASSWORD, DB_USER
} = process.env;

const gistUrlDB = `postgres://${DB_USER_CLOUD}:${DB_PASSWORD_CLOUD}@${DB_HOST_CLOUD}:${DB_PORT_CLOUD}/${DB_NAME_CLOUD}?sslmode=require`;
